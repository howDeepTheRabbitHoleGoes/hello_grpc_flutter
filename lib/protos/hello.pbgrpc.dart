...
class HelloClient extends $grpc.Client {
  static final _$say = $grpc.ClientMethod<$0.Request, $0.Response>(
      '/hello.Hello/Say',
  ...
  $grpc.ResponseFuture<$0.Response> say($0.Request request,
      {$grpc.CallOptions? options}) {
...
abstract class HelloServiceBase extends $grpc.Service {
  ...
  $async.Future<$0.Response> say_Pre(
      $grpc.ServiceCall call, $async.Future<$0.Request> request) async {
    return say(call, await request);
  }

  $async.Future<$0.Response> say($grpc.ServiceCall call, $0.Request request);
}
